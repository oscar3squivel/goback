...
/*
----------------------------------------------------
THESE DATATYPES ARE USED IN CASE A VALUE RETRIEVED
FROM THE DATABASE IS NULL.
THESE DATATYPES IMPLEMENT THE METHODS SCAN, MARSHALL
AND UNMARSHALL. IN THIS WAY THE JSON RESPONSES ARE
CLEANER.
----------------------------------------------------
*/
